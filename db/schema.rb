...
ActiveRecord::Schema.define(version: 20140426205837) do
  ...
  add_index "answers", ["user_id", "question_id", "response_id"], name: "index_answers_on_user_id_and_question_id_and_response_id"
